...
function Preview() {
  return (
    <div className=" grid md:grid-cols-2 w-full md:px-5 md:gap-4 px-5 font-three bg-[#efefef] pb-10 tracking-wide space-y-5 md:space-y-0 ">
      {/* 1 */}
      <div className="md:grid-cols-2 bg-white shadow-md">
        <img src="https://bit.ly/3b1uhwD" alt="" width="100%" />
      ...
      {/* 2 */}
      <div className="md:grid-cols-2 bg-white shadow-md">
        <img src="https://bit.ly/3mJxCD1" alt="" width="100%" />
        <div className="px-4 py-5 ">
      ...
      {/* 3 */}
      <div className="md:grid-cols-2 bg-white shadow-md">
        <img src="https://bit.ly/3tyXDc9" alt="" width="100%" />
        <div className="px-4 py-5 ">
      ...
      {/* 4 */}
      <div className="md:grid-cols-2 bg-white shadow-md">
        <img src="https://bit.ly/3NREn1G" alt="" width="100%" />
        <div className="px-4 py-5 ">
